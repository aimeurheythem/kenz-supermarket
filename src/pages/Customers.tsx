                        ...
                        <tbody className="divide-y divide-[var(--color-border)]">
                            {isLoadingCustomers ? (
                                ...
                                filteredCustomers.map((customer) => (
                                    <tr key={customer.id} className="group hover:bg-[var(--color-bg-hover)] transition-colors">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="text-[var(--color-text-primary)] font-medium">{customer.full_name}</p>
                                                    {customer.address && (
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={cn(
                                                "font-bold",
                                                (customer.total_debt || 0) > 0 ? "text-red-500" : "text-[var(--color-text-muted)]"
                                            )}>
